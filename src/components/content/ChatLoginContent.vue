...
<script>
import ChatPageLogin from '@/components/views/Chat/ChatPageLogin'

export default {
  components: {
    'chat-page-login': ChatPageLogin
  },
  methods: {
    addCodeLineNumber () {
      // 添加行号
